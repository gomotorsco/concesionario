...
export function VehicleLeadForm({
  ...
  return (
    <form onSubmit={submit} className="space-y-3 rounded-2xl border border-black/10 bg-zinc-950 p-5">
      <h2 className="text-lg font-semibold text-[#151515]">Consultar este vehículo</h2>
      ...
      <button disabled={loading} className="w-full rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-[#151515] disabled:opacity-60">
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full rounded-lg border border-black/10 bg-white px-3 py-2 text-sm text-[#151515]"
      />
    </div>
  );
}
