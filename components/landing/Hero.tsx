...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#efe8dc]">
      <div className="relative h-[640px] overflow-hidden md:h-[680px] lg:h-[720px]">
        <img
          src="/hero-mobile.png"
        ...
        <img
          ...
          className="absolute inset-0 hidden h-full w-full object-contain object-center brightness-[1.02] md:block"
        />
