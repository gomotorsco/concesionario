...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#efe8dc]">
      <div className="relative h-[640px] overflow-hidden lg:h-[680px]">
        <img
          src="/hero-0km.png"
          alt="Vehículo premium GoMotorsCo"
          className="absolute inset-0 h-full w-full object-contain md:object-cover object-center brightness-[1.02]"
        />
