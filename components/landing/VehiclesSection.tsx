                      ...
                      <div className="mt-3 space-y-2">
                        <button
                          ...
                          onClick={() => {
                            ...
                            trackGtag("cta_click", { origin: "vehicle_card", action: "open_modal", vehicle_id: v.id, vehicle_name: `${section.title} ${v.title}` });
                            trackInternal({
                              type: "cta_open_modal_vehicle",
                              origin: "vehicle_card",
                              vehicle_id: v.id,
                              vehicle_name: `${section.title} ${v.title}`,
                            });
                            openEntryModal();
                          }}
                        ...
                        <a
                          ...
                          onClick={() => {
                            trackGtag("whatsapp_click", { origin: "vehicle_card", vehicle_id: v.id, vehicle_name: `${section.title} ${v.title}` });
                            trackInternal({
